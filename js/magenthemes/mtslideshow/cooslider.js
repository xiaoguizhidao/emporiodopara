...
(function($) {
    ...
    Coo.Effect.Base = Class.extend({
        ...
        _showCurrentItem: function(selector) {
            $(this._currentItem).find('[data-effect]').addBack().each(function() {
                ...
                if (effect instanceof Coo.Effect.Base) {
                    effect.reset();
                }
            });
            if (null == selector) {
     ...
     */
    Coo.Effect.Default = Coo.Effect.Base.extend({
        play: function() {
            var that = this;
            $(this._currentItem).hide();
     ...
     */
    Coo.Effect.Css3Animate = Coo.Effect.Base.extend({
        _animate: function() {
            this.reset();
     ...
     */
    Coo.Effect._Circle = Coo.Effect.Base.extend({
     ...
     */
    Coo.Effect._Grid = Coo.Effect.Base.extend({
    ...
    Coo.Effect.BoxRandom = Coo.Effect._Grid.extend({
        _animate: function() {
            ...
            $boxes = Coo.Helper.shuffleArray($boxes);
    ...
    /**
     * v1.0.1: slideLeft, slideRight effects
     * v1.0.2: slideDown, slideUp effects
     */
     ...
     * boxFadeIn effect
     */
    Coo.Effect.BoxFadeIn = Coo.Effect.Base.extend({
