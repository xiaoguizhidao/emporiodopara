...
(function(jQuery){
  ...
  jQuery.fn.mColorPicker.events = function() {
    ...
    jQuery("#mColorPickerBg").live('click', jQuery.fn.mColorPicker.closePicker);
    ...
    jQuery('.mColorPickerTrigger').live('click', jQuery.fn.mColorPicker.colorShow);
  
    jQuery('.mColor, .mPastColor').live('mousemove', function(e) {
    ...
    }).live('click', jQuery.fn.mColorPicker.colorPicked);
  
    jQuery('#mColorPickerInput').live('keyup', function (e) {
    ...
    jQuery('#mColorPickerWrapper').live('mouseleave', function () {
  ...
  jQuerydocument.ready(function () {
    ...
    if (jQueryi.replace) {
      ...
      if (typeof jQuery.fn.mDOMupdate == "function") {
        ...
        jQuerydocument.live('ajaxSuccess.mColorPicker', jQuery.fn.mColorPicker.start);
      }
    }
  });
})(jQuery);
