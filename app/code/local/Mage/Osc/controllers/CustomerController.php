...
class Mage_Osc_CustomerController extends Mage_Adminhtml_CustomerController
{
    ...
    public function saveAction()
    {
        $data = $this->getRequest()->getPost();
         ...
         // Dados One Step Checkout
        $tipopessoa = $data['account']['tipopessoa'];

        if($tipopessoa == 'pf'){
        }else if($tipopessoa == 'pj'){
            $ie = $data['account']['ie']; // padrão do checkout
            $ieisento = $data['account']['ieisento']; // padrão do checkout
        ...
        if ($data) {
            ...
            if (!empty($data['address'])) {
                ...
                foreach (array_keys($data['address']) as $index) {
                    ...
                    $reference = ($data['address'][$index]['reference']); 
