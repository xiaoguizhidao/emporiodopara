 ...
 */
class Mage_Osc_Block_Adminhtml_Customer_Edit_Tab_Addresses extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    public function initForm()
    {
        ...
        $fieldset->addField('reference', 'text', array(
          'label'     => Mage::helper('adminhtml')->__('Referência para Entrega'),
          'name'      => 'reference',
          'tabindex' => 1
        ));
