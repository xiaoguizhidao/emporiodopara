...
class MagenThemes_MTDendAdmin_Block_Filter_Tool extends Mage_Core_Block_Template
{
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('magenthemes/filter/filter_toolbar.phtml');
    }
    ...
    {	 
        $pagerBlock = $this->getLayout()->createBlock('mtdendadmin/filter_pager'); 
