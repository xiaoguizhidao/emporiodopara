...
?>
<?php
class MagenThemes_MTDendAdmin_Block_ProductsScroller extends Mage_Catalog_Block_Product_List
{
    ...
    {
	$config = Mage::getStoreConfig('mtdendadmin');
	if (isset($config['productsscroller']) ) {
	    $value = $config['productsscroller'][$att];
	    return $value;
	} else {
