<?php
class MagenThemes_MTDendAdmin_Block_Navigation extends Mage_Catalog_Block_Navigation
{
    protected $_column;
                                                   ...
                                                   $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
        ...
        $exdrop = explode("\r\n",Mage::getStoreConfig('mtdendadmin/navigation/nav_urlkey'));
        if ($level == 0) {
            $description = $catdetail->getDescription();
            if ($urlkey != $block->getIdentifier() || !Mage::getStoreConfig('mtdendadmin/navigation/show_type')) {
        ...
        if (!empty($description) && !empty($htmlChildren) && Mage::getStoreConfig('mtdendadmin/navigation/show_type')=='category') {
            $htmlChildren .= '<li class="menu-category-description">' . $description;
            if (Mage::getStoreConfig('mtdendadmin/navigation/show_learn_more')) {
            ...
            $htmlChildren .= '</li>';
        }else if(!empty($urlkey) && !empty($htmlChildren) && Mage::getStoreConfig('mtdendadmin/navigation/show_type')=='static'){
