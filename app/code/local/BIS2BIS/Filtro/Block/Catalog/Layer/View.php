...
class BIS2BIS_Filtro_Block_Catalog_Layer_View extends Mage_Core_Block_Template
{
    /**
     * State block name
     *
    ...
    {
        $this->_stateBlockName              = 'filtro/catalog_layer_state';
        $this->_categoryBlockName           = 'filtro/catalog_layer_filter_category';
        $this->_attributeFilterBlockName    = 'filtro/catalog_layer_filter_attribute';
        $this->_priceFilterBlockName        = 'filtro/catalog_layer_filter_price';
        $this->_decimalFilterBlockName      = 'filtro/catalog_layer_filter_decimal';
    ...
    {
        return 'filtro/catalog_layer_filter_attribute';
    }
