    ...
    <table cellspacing="0" cellpadding="0" width="666" border="0">
      <tr>
        <td class="cp" width="150">
          <span class="campo"><img src="media/boleto_ultimate/logosicoob.jpg"
        ...
        <td class="cpt" width="58" valign="bottom">
          <div align="center">
            <font class=
            "bc" style="font-size:20px; font-weight:bold;"><?php echo $dadosboleto["codigo_banco"]?></font>
          </div>
        </td>
        <td width="3" valign="bottom">
          <img height="22" src="media/boleto_ultimate/3.png" width="2" border=
