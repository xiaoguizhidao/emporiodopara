...
/*<![CDATA[*/
 ...
 -->
        <div id="instr_content">
          <p>
            O pagamento deste boleto também poderá ser efetuado nos
          ...
          <ol style="margin:0;padding:0;">
            ...
            mm) e margens mínimas à esquerda e à direita do
            formulário.
            </li>
            <li>Corte na linha indicada. Não rasure, risque, fure
            ou dobre a região onde se encontra o código de barras
            </li>
          </ol>
        </div><!-- id="instr_content" -->
      </div><!-- id="instructions" -->
              ...
              <td class="last_line" rowspan="6">
                ...
                "0">
                  <tbody>
                    <tr class="titulos">
                      <td class="instrucoes">
                        Instruções (Texto de responsabilidade do
                        cedente)
                      </td>
                    </tr>
                    <tr class="campos">
          ...
          <tbody>
            <tr>
              <td width="666" align="right" height="5">
                <font style="font-size: 10px;">Autenticação
                mecânica - Ficha de Compensação</font>
              </td>
            </tr>
          </tbody>
        </table>
