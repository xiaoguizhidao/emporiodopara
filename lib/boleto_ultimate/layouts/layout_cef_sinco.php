        ...
        <td valign="top" class="cp">
          <div align="left">
            <ul>
              ...
              279 mm) e margens mínimas à esquerda e à direita do
              formulário.<br />
              </li>
              <li>Corte na linha indicada. Não rasure, risque, fure
              ou dobre a região onde se encontra o código de
              barras.<br />
              </li>
              <li>Caso não apareça o código de barras no final,
              clique em F5 para atualizar esta tela.
              </li>
              <li>Caso tenha problemas ao imprimir, copie a
              seqüencia numérica abaixo e pague no caixa eletrônico
    ...
    <table cellspacing="0" cellpadding="0" width="666" border="0">
      <tr>
        <td class="cp" width="150">
          <span class="campo"><img src="media/boleto_ultimate/logocaixa.jpg"
          width="150" height="40" border="0" /></span>
        </td>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td valign="top" width="268" height="1">
            <img height="1" src="media/boleto_ultimate/2.png" width="268" border=
            "0" />
          </td>
          <td valign="top" width="7" height="1">
            <img height="1" src="media/boleto_ultimate/2.png" width="7" border=
          ...
          <td valign="top" width="156" height="1">
            <img height="1" src="media/boleto_ultimate/2.png" width="156" border=
            "0" />
          </td>
          <td valign="top" width="7" height="1">
            <img height="1" src="media/boleto_ultimate/2.png" width="7" border=
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="cp" valign="top" width="659" height="12">
            <span class=
            "campo"><?php echo $dadosboleto["sacado"]?>,
            <?php echo $dadosboleto["sacadocpf"]?></span>
          </td>
        </tr>
        <tr>
          <td valign="top" width="7" height="1">
      ...
      <tbody>
        <tr>
          ...
          <td valign="top" width="469" rowspan="5">
            <font class="ct">Instruções (Texto de responsabilidade
            do cedente)</font><br />
            <br />
      ...
      <tbody>
        <tr>
          ...
          <td class="ct" width="250">
            <div align="right">
              Autenticação mecânica - <strong class="cp">Ficha de
              Compensação</strong>
            </div>
          </td>
        </tr>
