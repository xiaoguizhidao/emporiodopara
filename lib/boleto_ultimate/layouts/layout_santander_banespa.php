    ...
    <table cellspacing="0" cellpadding="0" width="666" border="0">
      <tr>
        <td class="cp" width="150">
          <span class="campo"><img src="media/boleto_ultimate/logosantander.jpg"
        ...
        <tr>
          ...
          <td class="cp" valign="top" width="126" height="12">
            <span class="campo">
              ...
              ?>
              <?php echo $dadosboleto["ponto_venda"]." <img src='media/boleto_ultimate/b.png' width='10' height='1'/>" . $tmp2 ?>
            </span>
          </td>
          <td class="cp" valign="top" width="7" height="12">
            <img height="12" src="media/boleto_ultimate/1.png" width="1" border=
